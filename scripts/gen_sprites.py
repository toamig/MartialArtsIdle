...
ENEMIES = {
    ...
    "iron_fang_wolf": {
        ...
        "idle_desc": (
            ...
            "sharp angular metallic qi wisps radiating from its body. All 4 frames are "
            "nearly identical — the wolf holds its dominant stance with only micro breathing shifts. "
            "Frame 1: base stance — body low and carried heavy, orange flame-eyes forward, "
            "metallic qi wisps crackling steadily at the flanks, utterly still. "
            "Frame 2: chest rising 1-2px on a slow breath, metallic qi wisps brightening "
            "slightly, nothing else moving. "
            "Frame 3: chest settling back down, qi wisps returning to baseline crackle, "
            "iron-grey fur completely still. "
            "Frame 4: identical to frame 1, breathing cycle complete, orange flame-eyes "
