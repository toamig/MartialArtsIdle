...
const MECHANIC_TIER_CONFIG = [
  ...
  },
  {
    ...
    label:      'Divine Qi',
    descTier:   { 2: 'Orb every ~2.5 min, 10s window. Tap for 16s of qi.',
                  3: 'Orb every ~2 min, 12s window. Tap for 20s of qi.',
                  4: 'Orb every ~90s, 15s window. Tap for 22s of qi.',
                  5: 'Two orbs every ~60s. Collect both for 25s qi + ×1.15 qi/s for 15s.' },
    costs:      { 2: 1_600_000, 3: 13_000_000, 4: 100_000_000, 5: 800_000_000 },
  },
  {
    mechanicId: 'pattern_click',
    label:      'Tracing Meridians',
    descTier:   { 2: 'Spark every ~100s. 4 dots, 12s window. Full clear: 16s of qi.',
                  3: 'Spark every ~80s. 5 dots, 14s window. Full clear: 20s of qi.',
                  4: 'Spark every ~60s. 6 dots, 16s window. Full clear: 25s of qi.',
                  5: 'Spark every ~45s. 7 dots, 18s window. Full clear: 35s qi + ×1.25 qi/s for 8s.' },
